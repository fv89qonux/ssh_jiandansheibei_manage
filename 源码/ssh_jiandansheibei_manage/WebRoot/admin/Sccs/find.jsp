...
<script type="text/javascript">                                         
	function topPage() {                                                    
		...
		window.location = contextPath                                         
				+ '/Sccs-getAllUtil.action?pageModel.currentPageNo=' + pageNo     
...
<body class="pos-r">                                                                  
	<div>                                                                                 
		...
		<span class="c-gray en">&gt;</span>生产厂商管理 <span class="c-gray en">&gt;</span>
		生产厂商列表 <a class="btn btn-success radius r"                                      
		...
		<div class="page-container">                                                      
			<div class="text-c">                                                            
				<form                                                                           
					action="${pageContext.request.contextPath}/Sccs-getAllUtil.action">    
...
<option <c:if test="${field == 's_0'}">selected</c:if> value="s_0" />
			...
			<a class="btn btn-primary radius" style="margin-left:20px;"                    
					href="${pageContext.request.contextPath}/Sccs-initUtil.action"><i                   
			...
			<div class="mt-20">                                                                                 
				<form                                                                                               
					action="${pageContext.request.contextPath}/Sccs-deleteManyUtil.action"                     
							...
							<td>
								...
								<c:if test="${type == 'admin'}">
									<td class="td-manage"><a style="text-decoration:none;margin-left:15px;"                                   
										class="ml-5"                                                                            
										href="${pageContext.request.contextPath}/Sccs-selectUtil.action?util.id=${tmp.id }"
										title="编辑"><i class="Hui-iconfont">&#xe6df;</i> 编辑</a> <a                             
										style="text-decoration:none;margin-left:15px;" class="ml-5"                           
										href="${pageContext.request.contextPath}/Sccs-deleteUtil.action?util.id=${tmp.id }"
