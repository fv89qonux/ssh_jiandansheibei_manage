...
<script type="text/javascript">                                         
	function topPage() {                                                    
		...
		window.location = contextPath                                         
				+ '/Bumen-getAllUtil.action?pageModel.currentPageNo=' + pageNo     
...
<body class="pos-r">                                                                  
	<div>                                                                                 
		...
		部门列表 <a class="btn btn-success radius r"                                      
		...
		<div class="page-container">                                                      
			<div class="text-c">                                                            
				<form                                                                           
					action="${pageContext.request.contextPath}/Bumen-getAllUtil.action">    
...
<option <c:if test="${field == 's_0'}">selected</c:if> value="s_0" />
			...
			<a class="btn btn-primary radius" style="margin-left:20px;"                    
					href="${pageContext.request.contextPath}/Bumen-initUtil.action"><i                   
			...
			<div class="mt-20">                                                                                 
				<form                                                                                               
					action="${pageContext.request.contextPath}/Bumen-deleteManyUtil.action"                     
							...
							<td>
								...
								<c:if test="${type == 'admin'}">
									<td class="td-manage"><a style="text-decoration:none;margin-left:15px;"                                   
										class="ml-5"                                                                            
										href="${pageContext.request.contextPath}/Bumen-selectUtil.action?util.id=${tmp.id }"
										title="编辑"><i class="Hui-iconfont">&#xe6df;</i> 编辑</a> <a                             
										style="text-decoration:none;margin-left:15px;" class="ml-5"                           
										href="${pageContext.request.contextPath}/Bumen-deleteUtil.action?util.id=${tmp.id }"
